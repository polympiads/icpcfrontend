...
function _PdfViewerToolbar(props: ParentProps) {
  return (
    <>
      <div
        class={`w-full h-9 flex flex-row items-center bg-slate-50 border-b border-b-slate-300 shadow-xs text-xs select-none sticky top-0 backdrop-blur-sm z-10 overflow-x-auto`}
      >
        { props.children }
      </div>
    </>
