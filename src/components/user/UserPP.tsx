...
export function UserPP(props: { src?: string, variant?: Variant }) {
  return (
    <>
      <BaseImage class={clsx("flex items-center justify-center", size_map[props.variant ?? "default"])}>
        ...
        <BaseImage.Fallback>
          <FaSolidUser size={fallback_size_map[props.variant ?? "default"]} class="opacity-40" />
        </BaseImage.Fallback>
      </BaseImage>
    </>
  )
...
export function UnkownUser(props: { src?: string, variant?: Variant }) {
  return (
    <>
      <div class={clsx("relative flex items-center justify-center", size_map[props.variant ?? "default"])}>
