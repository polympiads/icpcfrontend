...
export class SessionDB {
  ...
  static getSessionInformation (): Promise<{ sessionId: string | undefined, whoami: WhoAmI }> {
    return new Promise<{ sessionId: string | undefined, whoami: WhoAmI }>(async (resolve, reject) => {
  ...
  static async setSessionInformation (sessionId: string | undefined, whoami: WhoAmI) {
