...
export function languageEquals (j1: Language | undefined, j2: Language | undefined) {
...
export function languageDictsEquals (j1: {[key: string]: Language }, j2: {[key: string]: Language }) {
