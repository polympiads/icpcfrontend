...
export function accountEquals(
  j1: Account | undefined,
  j2: Account | undefined,
) {
...
export function teamEquals(j1: Team | undefined, j2: Team | undefined) {
  ...
  return (
    j1.display_name == j2.display_name && j1.name == j2.name && j1.id == j2.id
  );
}
export function teamDictsEquals(
  j1: { [key: string]: Team },
  j2: { [key: string]: Team },
) {
