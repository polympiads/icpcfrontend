...
function BaseSplitPanel(props: PolymorphicProps<"div", BaseSplitPanelProps>) {
  ...
  const styleList = mergeProps(
    (props.includeMargin ?? false) && {
      padding: `${props.gutterSize ?? 10}px`,
    },
  );
...
export function SplitPanel(props: PolymorphicProps<"div", AppSplitPanelProps>) {
  return <BaseSplitPanel {...props} gutter={SplitPanelGutter} />;
}
