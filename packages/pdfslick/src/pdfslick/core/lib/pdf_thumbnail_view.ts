...
import type { OptionalContentConfig, PDFViewerOptions } from "pdfjs-dist/types/web/pdf_viewer";
...
class TempImageFactory {
  ...
  static getCanvas(width: number, height: number) {
    const tempCanvas = (TempImageFactory.#tempCanvas ||= document.createElement("canvas")) as HTMLCanvasElement;
